...
INSERT INTO `sale_cart` VALUES (1,0.00,1),(2,115626.00,2),(3,0.00,3),(4,0.00,4),(5,0.00,5),(6,0.00,6),(7,0.00,7),(8,0.00,8),(9,0.00,9),(10,0.00,10);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='出售购入车条目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_cart_item` VALUES (7,10,4058.60,1,2),(8,40,1876.00,4,2);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='出售订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sale_order_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `sale_order_item_model_id_fk` (`model_id`),
  KEY `sale_order_item_sale_order_id_fk` (`sale_order_id`),
  CONSTRAINT `sale_order_item_model_id_fk` FOREIGN KEY (`model_id`) REFERENCES `model` (`id`),
  CONSTRAINT `sale_order_item_sale_order_id_fk` FOREIGN KEY (`sale_order_id`) REFERENCES `sale_order` (`id`)
...
-- Dump completed on 2022-08-29  1:31:07
